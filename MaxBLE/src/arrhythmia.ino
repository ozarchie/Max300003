...
float rr_new[MSGMAX-1][2]={0};
float sum[MSGMAX-1]={0};
float os[MSGMAX-1]={0};
float drr[MSGMAX-1][2]={0};
float drr_s[MSGMAX-1]={0};
float drrnew[MSGMAX-1][2]={0};
